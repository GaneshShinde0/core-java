...
class Task1 extends Thread {
	...
	public void run() {
		MultiThreadingExamples.threadArray[0] = Task1.a;
		for (int i = beg + 1; i < a; i++) {

			MultiThreadingExamples.threadArray[i] = i;
		}
	}
}
...
public class MultiThreadingExamples {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		MultiThreadingExamples solution = new MultiThreadingExamples();
		int one = sc.nextInt();
		Task1.a = one;
		Task1.beg = 0;
		int two = sc.nextInt();
		...
		System.out.println(MultiThreadingExamples.threadArray.toString());
	}
}