	...
	public String output(int capacity, int stops, List<String> listOfInputStrings, String query) {
		...
		while (st3.hasMoreTokens()) {
			...
			if (q.compareTo("1") == 0) {
				...
				// return a+" passenger spent a fare of "+1.6*capacity+", "+b+" passengers spent
				// a fare of "+1.3*capacity+" and "+c+" passengers spent a fare of "+capacity;
				// return a+" passengers traveled with a fare of "+1.6*capacity+", "+b+"
				// passengers traveled with a fare of "+1.3*capacity+" and "+c+" passengers
				// traveled with a fare of "+capacity;
				String xx = a + " passengers traveled with a fare of " + (Math.round(1.6 * capacity * 100.0) / 100.0)
						+ ", " + b + " passengers traveled with a fare of "
						+ (Math.round(1.3 * capacity * 100.0) / 100.0) + " and " + c
						+ " passengers traveled with a fare of " + (Math.round(capacity * 100.0) / 100.0);
				System.out.println(xx.hashCode());
				System.out.println(a + " passengers traveled with a fare of "
						+ (Math.round(1.6 * capacity * 10.0) / 10.0) + ", " + b + " passengers traveled with a fare of "
						+ (Math.round(1.3 * capacity * 10.0) / 10.0) + " and " + c
						+ " passengers traveled with a fare of " + (Math.round(capacity * 10.0) / 10.0));
				return a + " passengers traveled with a fare of " + (Math.round(1.6 * capacity * 10.0) / 10.0) + ", "
						+ b + " passengers traveled with a fare of " + (Math.round(1.3 * capacity * 10.0) / 10.0)
						+ " and " + c + " passengers traveled with a fare of " + (Math.round(capacity * 10.0) / 10.0);
