package com.ganesh.basic.advance.nestedclassesandtypes13.challenge;

import com.ganesh.basic.advance.nestedclassesandtypes13.challenge.record.Employee;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Employee e1 = new Employee("Tom","Scott", "01/01/2014");
        Employee e2 = new Employee("Micheal","Ben", "01/05/2018");
        Employee e3 = new Employee("Anne","Levy", "01/07/2017");
        Employee e4 = new Employee("Luffy","Monkey", "01/01/2022");
        Employee e5 = new Employee("Zoro","Vinsmoke", "16/11/2019");
