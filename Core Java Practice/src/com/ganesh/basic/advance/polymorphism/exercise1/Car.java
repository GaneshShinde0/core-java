package com.ganesh.basic.advance.polymorphism.exercise1;
...
class GasPoweredCar extends Car{
    ...
    public GasPoweredCar(String description, double avgKmPerLiter, int cyliders){
        super(description);
...
class ElectricCar extends Car{
    ...
    public ElectricCar(String description, double avgKmPerCharge, int cyliders){
        super(description);
